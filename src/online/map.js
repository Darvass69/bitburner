// advanced map
// uses HTML to be able to see when hovering and to autoconnect
// https://www.reddit.com/r/Bitburner/comments/rhpp8p/scan_script_updated_for_bitburner_v110/

// special servers and respective colors
let facServers = {
    "CSEC" : "yellow",
    "avmnite-02h" : "yellow",
    "I.I.I.I" : "yellow",
...
// create an object with {name, depth} for a server
    ...
    getServers(ns).forEach(server => {
        ...
        output += ["<br>", "---".repeat(server.depth),
            ...
            onClick="(function()
            {
                ...
                terminalInput.value='home; run online/connect.js ${name}';
